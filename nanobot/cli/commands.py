...
def channels_login():
    """(Not supported) Login is only used by removed channels."""
    console.print("[yellow]channels login is not supported in this build (only Telegram + Web UI are kept).[/yellow]")
